...
// FIXME: 2020-07-15 新增备注Bak
    ...
    Observable<BaseResult<GetFactoryData<Service>>> GetFactoryService(@Field("FCategoryID") String FCategoryID);
...
//分页有效
     ...
     */
    @FormUrlEncoded
    @POST("master/AppLeavemessage/List")
    Observable<GetLeaveMsgListResult> GetLeaveMsgList(@Field("OrderId") String OrderId);
    ...
    @FormUrlEncoded
    @POST("master/AppOrder/List")
    Observable<OrderListResult> GetOrderList(@Field("Search") String Search,
                                             @Field("State") String State,
                                             @Field("page") String page,
                                             @Field("limit") String limit);
