...
/*预接单的添加配置*/
public class Pre_order_Add_Ac_Adapter extends BaseQuickAdapter<FAccessory, BaseViewHolder> {

    public Pre_order_Add_Ac_Adapter(int layoutResId, @Nullable List<FAccessory> data) {
