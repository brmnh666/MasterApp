...
public class OrderAdapter extends BaseQuickAdapter<OrderListResult.DataBeanX.DataBean, BaseViewHolder> {
    private String type;
    ...
    public OrderAdapter(int layoutResId, @Nullable List<OrderListResult.DataBeanX.DataBean> data,String type,String userId) {
