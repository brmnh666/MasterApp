...
public class WorkOrder implements Serializable {
    ...
    public static class accessoryDataBean implements Serializable{
         ...
         * Quantity : 1
         * OrderID : 2000010402
         * CreateTime : 2020-07-28T10:21:56
         * Relation : 84ffef61-c791-4c05-9325-bc3550331226
         * Price : 0
         * DiscountPrice : 0
         * IsUse : Y
         * SendAddress : 北京市北京市东城区东华门街道办事处测试
         * IsPay : Y
         * ExpressNo : 1
         * State : 2
         * AccessoryState : 0
         ...
         * AddressBack : 浙江省宁波市慈溪市新浦镇环镇北路988号(收件人：夏学英 联系电话：18805848976)
         * QApplyNum : 0
         * limit : 999
         * page : 1
         * BeyondDistance : null
