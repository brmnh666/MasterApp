...
/*返件单*/
public class Returnedparts_Fragement extends BaseFragment<GetOrderListForMePresenter,GetOrderListForMeModel> implements GetOrderListForMeContract.View, ReturnAccessoryContract.View {
    private View view;
