...
/*预接单的添加配置*/
public class Pre_order_Add_Service_Adapter extends BaseQuickAdapter<FService, BaseViewHolder> {

    public Pre_order_Add_Service_Adapter(int layoutResId, @Nullable List<FService> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, FService item) {
