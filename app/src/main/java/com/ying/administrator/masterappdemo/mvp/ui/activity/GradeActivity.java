...
public class GradeActivity extends BaseActivity<AddSkillsPresenter, AddSkillsModel> implements View.OnClickListener, AddSkillsContract.View {
    ...
    protected void initView() {
        ...
        MySkills skills= (MySkills) getIntent().getSerializableExtra("skills");
