...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs) {
        ...
        // Configurable parameters
        try {
            mMinWidth = a.getDimensionPixelSize(R.styleable.SignatureView_minWidth, convertDpToPx(6));
            mMaxWidth = a.getDimensionPixelSize(R.styleable.SignatureView_maxWidth, convertDpToPx(14));
...
//            mSignatureBitmapCanvas.drawBitmap(BitmapFactory.decodeResource(getResources(), R.drawable.signbg),
//                    new Rect(0, 0, BitmapFactory.decodeResource(getResources(), R.drawable.signbg).getWidth(),
//                            BitmapFactory.decodeResource(getResources(), R.drawable.signbg).getHeight()),
