...
//    private String messageStr;
    ...
    protected AdDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_ad);//自定义布局
