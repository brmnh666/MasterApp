...
//        baseViewHolder.setText(R.id.tv_complete,item.getAddress());//已完成
        ...
        if ("安装".equals(item.getTypeName())){
            baseViewHolder.setBackgroundColor(R.id.tv_tv_complete_status_install,R.color.color_custom_01);
        }else{
            baseViewHolder.setBackgroundColor(R.id.tv_tv_complete_status_install,R.color.color_custom_04);
        }
